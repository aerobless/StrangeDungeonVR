...
namespace SixtyMeters.tiles.scripts
{
    public class DungeonGenerator : MonoBehaviour
    {
        ...
        private void AttachNewTile(TileDoor tileDoor, List<DungeonTile> createdTiles)
        {
            var newTile2 = Instantiate(tiles[0], Vector3.zero, Quaternion.identity);
            AlignAndAttachTileDoor(tileDoor, newTile2);
            tileDoor.Attach();
